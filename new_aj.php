<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "insert into `achat` (medicamentID, distributeur, prixUnitaire, quantite) values('$medicamentID', '$distributeur', '$prixUnitaire', '$quantite')";
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <a class="profile" id="profile" href="profile.php" title="Mon profile">
        ...
        <a class="selected submenu mini-size" href="new_ff.php">Achats</a>
    ...
    <div class="profile-container">
        <div class="retour">
            <a href="new_aff.php" class="btn btn-primary"> <h4>Achats <<<</h4></a><h4> Ajout d'un achat</h4>
        </div>
        <div class="profile-div" id="profile-div">
            <form method="post" class="profile-form">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" id="distributeur" name="distributeur" placeholder="Saisissez le distributeur ici" required>
                </div>
                <div>
                    <label for="prixUnitaire" class="form-label">Prix unitaire</label>
                    <input type="number" class="form-control" id="prixUnitaire" name="prixUnitaire" placeholder="Saisissez le prix unitaire" required>
                </div>
                <div>
                    <label for="quantite" class="form-label">Quantité</label>
                    <input type="number" class="form-control" id="quantite" name="quantite" placeholder="Saisissez la quantite ici(un nombre)" required>
                </div>
